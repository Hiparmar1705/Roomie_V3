  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen
        ...
        options={{ headerShown: true, title: 'Property Details', headerTintColor: colors.primary }}
      />
      <Stack.Screen
      ...
      />
      <Stack.Screen
        name={STACK_ROUTES.SUPPORT}
        component={SupportScreen}
        options={{ headerShown: true, title: 'Support', headerTintColor: colors.primary }}
      />
    </Stack.Navigator>
  );
}
