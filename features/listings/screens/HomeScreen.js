...
export default function HomeScreen({ navigation }) {
  ...
  const loadData = useCallback(async () => {
    // home reloads both the feed and saved ids whenever the screen comes back
  ...
  const handleToggleFavorite = async (listingId) => {
    ...
    // only students can save listings, so landlords just skip this path
    await listingService.toggleFavorite(listingId, user);
    const nextFavoriteIds = await listingService.getFavoriteIds(user);
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.summaryCard}>
          ...
          <View style={styles.summaryItem}>
            <Text style={styles.summaryValue}>{isStudent ? favoriteIds.length : rooms.length}</Text>
