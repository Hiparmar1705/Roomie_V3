          ...
          {listings.map((listing) => (
            <View key={listing.id} style={styles.compareCard}>
              ...
              <View style={styles.cardBody}>
                ...
                <ComparisonField label="Type" value={listing.type} />
                <ComparisonField label="Location" value={listing.location} />
                <ComparisonField label="Distance" value={`${listing.distanceKm} km from UNBC`} />
                <ComparisonField label="Landlord" value={listing.landlordName} />
                <ComparisonField label="Description" value={listing.description} />
              </View>
            </View>
          ))}
        </ScrollView>
